...
```{r echo=FALSE, out.width = "50%", fig.align='center', cache=FALSE, fig.cap="(Source: Jati.P, 2018)"}
...
```{r echo=FALSE, out.width = "50%", fig.align='center', cache=FALSE, fig.cap="(Source: Weida.Y, 2016)"}
